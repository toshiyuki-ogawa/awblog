...
PYTHONPATH=$python_paths DOCUMENT_ROOT=$docroot DTRACK_CONFIG=$dtrack_config ACC_CTRL_CONFIG=$acc_ctrl_config AWBLOG_CONFIG=$awblog_config python3 $script_dir/test-srv.py -d docroot
